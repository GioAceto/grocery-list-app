    ...
    >
      ...
      <div class="mb-4 lg:mb-0">
        ...
        <select
          id="units"
          v-model="units"
          class="mr-4 py-2 px-4 w-24 bg-gray-200 appearance-none border-2 border-gray-200 rounded text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500 select"
          type="select"
        >
          <option
            v-for="(unit, index) in store.units"
            :key="index"
            :value="unit"
          >
            {{ unit }}
